...
const HomePage = () => {
    ...
    const Icon = (props: { icon: React.ComponentType }) => {
        ...
        return <IconComponent className="text-2xl" />; // Увеличиваем иконки
    };
    ...
    return (
        <main className="min-h-screen bg-white">
                        ...
                        {steps.map((step, index) => (
                            <div
                                ...
                                style={{
                                    ...
                                    width: '100%',
                                    minHeight: '180px' // Увеличиваем высоту блока
                                }}
                            >
                                <div
                                    className="flex items-center justify-center w-12 h-12 md:w-16 md:h-16 mb-4 md:mb-6" // Увеличиваем размер иконки
                                    style={{
                                ...
                                <div className="flex flex-col items-center gap-2 w-full">
                                    <h3 className="text-lg md:text-xl font-semibold text-[#121212] text-center"> {/* Увеличиваем текст */}
                                        {step.title}
                                    </h3>
                                    <p className="text-base md:text-lg font-normal text-[#121212] text-center"> {/* Увеличиваем текст */}
                                        {step.description}
                                    </p>
                                </div>
                            </div>
            ...
            {/* Categories - передаем пропсы для увеличения */}
            <Categories
                iconSize={32} // Увеличиваем размер иконок в категориях
                textSize="text-lg" // Увеличиваем размер текста
                titleSize="text-2xl md:text-3xl" // Увеличиваем размер заголовка
            />

            {/* Latest Listings */}
            <section className="py-12 md:py-16">
                <div className="container mx-auto px-4">
                    <h2 className="text-2xl md:text-3xl font-bold text-center mb-8 md:mb-12">Последние объявления</h2>
                    {isLoading ? (
                        ...
                        <p className="text-center text-gray-500 text-lg">Пока нет объявлений</p>
                    )}
                </div>
            </section>
